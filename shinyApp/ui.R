  ...
  tabsetPanel(
    tabPanel("About",
      fluidRow(
        column(12,
          br(),
          HTML( "<p style='font-size:15px'><b>Website accompanying the papers </b>
                <ul>
                <li><b>Characterization of a common progenitor pool of the epicardium and myocardium,</b>
                by Tyser, Ibarra-Soria et al., <i>Science</i>, 2021. 
                <a href='https://doi.org/10.1126/science.abb2986'>DOI: 10.1126/science.abb2986</a></li></p><br>
                <li><b>Molecular characterization of Left-Right symmetry breaking in the mouse embryo,</b>
                by Tyser et al., <i>bioRxiv</i>, 2023. 
                <a href='https://www.biorxiv.org/content/10.1101/2022.12.26.521947v1'>DOI: 10.1101/2022.12.26.521947</a></li></p><br>" ),
          hr()
        )
      ),
      fluidRow(
        column(7,
          ...
          HTML( "<p><li><b>Reference dataset: </b>type in a gene of interest to plot its expression
                ...
                Clicking on a row in the table will show the corresponding expression plot.</li></p>" ),
          HTML( "<p><li><b>Left-right gene expression: </b>type in a gene of interest to plot its expression
                in the UMAP low dimensional space, with cells from the left and right side of the embryo plotted separately.</li></p><br>" )
        ),
        column(4,
    ...
    tabPanel("Left-right gene expression",
             fluidRow(
               column(3,
                      div(style = "height:20px"),
                      selectizeInput("gene_lr", label = "Type gene of interest", 
                                     choices = NULL, size=10,
                                     options = list( placeholder = 'Please type a gene name' )
                      ),
                      img(src = "UMAP.png", height = 220, width = 270)
               ...
               column(4,
                      div(style = "height:70px"),
                      withSpinner( plotlyOutput("expression_UMAPplot_lr"), type = 6, size = 0.5)
               ),
               column(4,
                      div(style = "height:70px"),
                      withSpinner( plotlyOutput("expression_boxplot_lr"), type = 6, size = 0.5)
               )
             )
    ),
  )
